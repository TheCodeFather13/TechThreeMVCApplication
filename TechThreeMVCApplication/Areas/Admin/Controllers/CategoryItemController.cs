...
using TechThreeMVCApplication.Data;
using TechThreeMVCApplication.Entities;
using TechThreeMVCApplication.Extentions;

namespace TechThreeMVCApplication.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Create(int categoryId)
        {
            ...
            {
                CategoryId = categoryId,
                MediaTypes = mediaTypes.ConvertToSelecList(0)
            };
            return View(categoryItem);
        }
